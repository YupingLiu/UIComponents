...
{
    public abstract class AllowDeactiveHorizontalOrVerticalLayoutGroup : AllowDeactiveLayoutGroup
    {
        ...
        protected void CalcAlongAxis(int axis, bool isVertical)
        {
            ...
            for (int i = 0; i < rectChildren.Count; i++)
            {
                ...
                float min = AllowDeactiveLayoutUtility.GetMinSize(child, axis, allowDeactiveChild);
                float preferred = AllowDeactiveLayoutUtility.GetPreferredSize(child, axis, allowDeactiveChild);
                float flexible = AllowDeactiveLayoutUtility.GetFlexibleSize(child, axis, allowDeactiveChild);
